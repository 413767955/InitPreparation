...
import com.dkcr.blibala.ui.recommend.interfaces.OnStartSwipeRefreshListener;
...
public class Utils {
    ...
    public static int dp2px(float dpValue) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dpValue, MyApp.getInstance().getResources().getDisplayMetrics());
    }
