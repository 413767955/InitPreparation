...
import com.dkcr.blibala.ui.recommend.bean.OtherInfoBean;
import com.dkcr.blibala.ui.recommend.bean.TranslationState;
import com.dkcr.blibala.ui.recommend.bean.UserBean;
import com.dkcr.blibala.ui.recommend.interfaces.OnItemClickPopupMenuListener;
import com.dkcr.blibala.ui.recommend.interfaces.OnPraiseOrCommentClickListener;
import com.dkcr.blibala.util.TimerUtils;
import com.dkcr.blibala.util.Utils;
import com.dkcr.blibala.util.span.TextMovementMethod;
import com.dkcr.blibala.widget.friends_circle.CommentOrPraisePopupWindow;
import com.dkcr.blibala.widget.friends_circle.NineGridView;
import com.dkcr.blibala.widget.friends_circle.VerticalCommentWidget;
...
public class FriendCircleAdapter extends RecyclerView.Adapter<FriendCircleAdapter.BaseFriendCircleViewHolder>
    ...
    public BaseFriendCircleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == FriendCircleConstant.FriendCircleType.FRIEND_CIRCLE_TYPE_ONLY_WORD) {
            return new OnlyWordViewHolder(mLayoutInflater.inflate(R.layout.item_recom_image_one, parent, false));
        } else if (viewType == FriendCircleConstant.FriendCircleType.FRIEND_CIRCLE_TYPE_WORD_AND_URL) {
            return new WordAndUrlViewHolder(mLayoutInflater.inflate(R.layout.item_recycler_firend_circle_word_and_url, parent, false));
        } else if (viewType == FriendCircleConstant.FriendCircleType.FRIEND_CIRCLE_TYPE_WORD_AND_IMAGES) {
    ...
    private void updateTargetItemContent(int position, BaseFriendCircleViewHolder baseFriendCircleViewHolder,
        ...
        if (translationState == TranslationState.START) {
            if ( baseFriendCircleViewHolder.layoutTranslation != null) {
            ...
            baseFriendCircleViewHolder.translationDesc.setText(R.string.in_translation);
