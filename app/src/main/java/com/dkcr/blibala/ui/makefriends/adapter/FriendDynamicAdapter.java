...
import com.dkcr.blibala.ui.mine.adapter.LifeImgAdapter;
 ...
 * @Date: 2022/8/2 15:26
 */
public class FriendDynamicAdapter extends BaseQuickAdapter<LifeRecordEntity, BaseViewHolder> {

    private RecyclerView recyclerView;
    private RecyclerView rvComment;

    public FriendDynamicAdapter(@Nullable List<LifeRecordEntity> data) {
        super(R.layout.item_friend_dynamic, data);
    }
