...
import com.zlx.module_network.util.RxUtils;
...
//    }
    ...
    private void onError(ApiCallback<R> callback, Throwable throwable, boolean toast) {
        callback.onError(ExceptionHandle.handleException(throwable));
        //ToastUtils.showShort(ExceptionHandle.handleException(throwable).message);
        LogUtils.e(ExceptionHandle.handleException(throwable).message+"----"+ExceptionHandle.handleException(throwable).code);
    }
