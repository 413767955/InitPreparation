...
import com.zlx.module_base.base_api.res_data.account.UserInfo;
...
public class MMkvHelper {
    ...
    public void logout() {
        ...
        mmkv.remove(C.AUTHORIZATION);
    }

    public void saveAuthorization(String authorization){
        mmkv.encode(C.AUTHORIZATION,authorization);
    }

    public String getAuthorization(){
        return mmkv.decodeString(C.AUTHORIZATION,"");
    }

    public void saveNoviceGuideState(boolean state){
        mmkv.encode(C.CLOSE_NOVICE_GUIDE,state);
    }
    public boolean getNoviceGuideState(){
        return mmkv.decodeBool(C.CLOSE_NOVICE_GUIDE,false);
    }
}
